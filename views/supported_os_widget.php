<div class="col-md-6">
    ...
    <div class="panel panel-default" id="os-supported-widget">

        <div class="panel-heading">
            <h3 class="panel-title"><i class="fa fa-apple"></i>
                <span data-i18n="machine.supported.title">macOS Supported</span>
...
$(document).on('appReady', function() {
    ...
    d3.json(supportedUrl, function(err, supportedData) {
        ...
        d3.json(osUrl, function(err, data) {
            ...
            var panelWidth = d3.select('#os-supported-widget .panel-body').style("width");
            ...
            nv.addGraph(function() {
                ...
                nv.utils.windowResize(function() {
                    panelWidth = d3.select('#os-supported-widget .panel-body').style("width");
                ...
                chart.discretebar.dispatch.on('elementClick', function(e) {
                    ...
                    window.location.href = appUrl + '/show/listing/reportdata/clients#' + majorVersion;
                });
